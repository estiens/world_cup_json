...
ActiveRecord::Schema.define(version: 20_180_626_044_822) do
  ...
  add_index 'match_statistics', %w[team_id match_id], name: 'index_match_statistics_on_team_id_and_match_id', using: :btree
